...
mainCyclist.setCollider("circle",111,111,300);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCGroup.isTouching(mainCyclist)){
    ...
    yellowCGroup.setLifetimeEach(-1);
  
    redCGroup.setVelocityXEach(0);
    redCGroup.setLifetimeEach(-1);
...
function pinkCyclists(){
        ...
        player1.setCollider("circle",111,111,250);
        player1.debug = false;
...
function yellowCyclists(){
        ...
        player2.setCollider("circle",111,111,250); 
        player2.debug = false;
...
function redCyclists(){
        ...
        player3.setCollider("circle",111,111,250);
        player3.debug = false; 
